def call(Map params) {
    ...
    if ('' != params.RANCHER_IMAGE_TAG && params.RANCHER_IMAGE_TAG != null) { return params.RANCHER_IMAGE_TAG }
    if ('' != params.RANCHER_CHART_VERSION && params.RANCHER_CHART_VERSION != null) { return "v" + params.RANCHER_CHART_VERSION }
